      ...
      var child0 = (function() {
        ...
        return {
          ...
          build: function build(dom) {
            ...
            dom.setAttribute(el4,"class","col-md-1 col-xs-1 col-sm-1");
            ...
            dom.appendChild(el3, el4);
            var el4 = dom.createElement("div");
            dom.setAttribute(el4,"class","col-md-11 col-xs-11 col-sm-11");
            var el5 = dom.createTextNode("\n");
            dom.appendChild(el4, el5);
            var el5 = dom.createComment("");
            dom.appendChild(el4, el5);
          ...
          render: function render(context, env, contextualElement) {
            ...
            var morph5 = dom.createMorphAt(element8,4,4);
            var morph6 = dom.createUnsafeMorphAt(element7,3,3);
            var morph7 = dom.createMorphAt(dom.childAt(element3, [7, 3]),1,1);
